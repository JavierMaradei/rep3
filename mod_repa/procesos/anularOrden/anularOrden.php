        ...
        <div class="mb-3 mt-3">
            <div class="row">
                <div class="col-md-12 text-end">
                    <h2><i>Anular orden</i></h2>
                </div>
            </div>
        </div>
    </div>
</div>
<form id="inputsAnularOrden">
    <div class="row mt-3">
        <div class="col-md-12 mb-3">
            <div class="card h-100" style="box-shadow: 0 0 1px grey !important;">
                <h4 class="card-header bg-black text-white text-center"><i>Anulación de orden</i></h4>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-2">
                            ...
                            <select id="motivo" class="form-select"></select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-sm-12 text-center mt-2">
                            ...
                            <button id="btnAnularOrden" type="button" class="btn btn-lg btn-success">Anular orden</button>
...
<script src="./mod_repa/procesos/anularOrden/script.js?v=<?php echo uniqid();?>"></script>