(() =>{
    ...
    function recargaTabla(){
        ...
        xhr.open('POST', 'mod_repa/informes/embalajes/embalajes_search.php')//Envío la información del filtro
        xhr.send(formData)
