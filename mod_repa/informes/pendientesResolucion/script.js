(() =>{
    ...
    let f_inicial               = document.querySelector('#desdeFechaEmbalaje')
    let f_final                 = document.querySelector('#hastaFechaEmbalaje')
    ...
    let inputsFiltrado          = [clienteApellido, clienteNombre, clienteTelefono, clienteCelular, clienteEmail, calle, numeroCalle, dpto]
    ...
    let tabla = $('#tabla').DataTable( {
        ...
        buttons: [
            {extend: 'copy'},
            {extend: 'csv'},
            {extend: 'excel', title: 'Informe de ordenes pendiente de resolución'},
            {extend: 'pdf', title: 'Informe de ordenes pendiente de resolución'},
            {extend: 'print',}
        ],
        "bLengthChange": false,
        "iDisplayLength": 10,
    ...
    function recargaTabla(){
        ...
        xhr.open('POST', 'mod_repa/informes/pendientesResolucion/pendientesResolucion_search.php')//Envío la información del filtro
        xhr.send(formData)
