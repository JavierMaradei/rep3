...
<div class="row mt-3">
    <div class="col-md-4 mb-3">
        <div class="card h-100">
            <h4 class="card-header bg-dark text-white text-center"><i>Forma de Retiro</i></h4>
    ...
    <div class="col-md-8 mb-3">
        <div class="card h-100">
            <h4 class="card-header bg-dark text-white text-center"><i>Listado de Formas de Retiro</i></h4>
            <div class="card-body">
                <div class="row mb-2">
