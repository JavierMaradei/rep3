<div class="content__boxed bg-gray-500" style="background-image: url('./img/banner.jpg'); background-size: cover; border-radius: 10px;">
    <div class="content__wrap">
        <div class="mb-3 mt-3 text-end">
            <h2><i style="color: white;">Estados de Reparación</i></h2>
        </div>
    </div>
</div>
<div class="row mt-3">
    <div class="col-md-5 mb-3">
        <div class="card h-100">
            <h4 class="card-header bg-light text-center"><i>Lugar de Recepción</i></h4>
    ...
    <div class="col-md-7 mb-3">
        <div class="card h-100">
        <h4 class="card-header bg-light text-center"><i>Listado de Lugares de Recepción</i></h4>
            <div class="card-body">
                <div class="row mb-2">
