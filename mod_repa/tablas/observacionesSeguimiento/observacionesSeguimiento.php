<div class="content__boxed bg-gray-500">
    <div class="content__wrap">
        <div class="mb-3 mt-3 text-end">
            <h2><i>Observaciones de seguimiento</i></h2>
        </div>
    </div>
</div>
<div class="row mt-3">
    <div class="col-md-4 mb-3">
        <div class="card h-100">
            <h4 class="card-header bg-dark text-white text-center"><i>Observación de seguimiento</i></h4>
            <form id="form">
                <div class="card-body">
                    <div class="row mb-2">
    ...
    <div class="col-md-8 mb-3">
        <div class="card h-100">
            <h4 class="card-header bg-dark text-white text-center"><i>Listado de Observaciones de seguimiento</i></h4>
            <div class="card-body">
                <div class="row mb-2">
