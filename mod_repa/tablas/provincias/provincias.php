...
<div class="row mt-3">
    <div class="col-md-4 mb-3">
        <div class="card h-100">
            <form id="formProvincias">
                <h4 class="card-header bg-dark text-white text-center"><i>Provincia</i></h4>
                <div class="card-body">
                    <div class="row mb-2">
    ...
    <div class="col-md-8 mb-3">
        <div class="card h-100">
            <h4 class="card-header bg-dark text-white text-center"><i>Listado de Provincias</i></h4>
            <div class="card-body">
                <div class="row mb-2">
