        ...
        <div class="col-lg-8 m-b">
            <div class="ibox float-e-margins">
                <div class="ibox-title text-center">
                    <h3>Listado de Motivos de Anulación</h3>
                </div>
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table id="tabla_motivosAnulacion" class="table table-striped table-hover">
                            <thead>
                                <th>Código</th>
                                <th>Descripción</th>
                                <th>Activo</th>                            
                                    ...
                                    <div class="input-group-addon">
                                        <div class="switch">
                                            <div class="onoffswitch">
                                                <input type="checkbox" class="onoffswitch-checkbox" id="activoMotivosAnulacion" checked>
                                                <label class="onoffswitch-label" for="activoMotivosAnulacion">
...
<script src="./mod_sirep/admin/tablas/motivosAnulacion/script_motivosAnulacion.js"></script>