            ...
            <div class="header__inner">
                ...
                <div class="header__brand">
                    <div class="brand-wrap">
                        ...
                        <!-- Brand logo -->
                        <a href="index.php?page=home" class="brand-img stretched-link">
                            <img src="assets/img/logo.jpg" alt="Nifty Logo" class="Nifty logo" width="40" height="40">
                        </a>

                        <!-- Brand title -->
                        <div class="brand-title">Hidroeléctrica del Norte</div>
                            ...
                            <div class="dropdown-menu dropdown-menu-end w-md-450px">
                                ...
                                <div class="d-flex align-items-center border-bottom px-3 py-2">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <span class="text-muted fst-italic"><a href="https://themeon.net/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="aecfcfdcc1c0f1cdc6cfd8cbd4eecbd6cfc3dec2cb80cdc1c3">[email&#160;protected]</a></span>
                                    </div>
                                </div>
